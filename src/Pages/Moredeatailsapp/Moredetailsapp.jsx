    ...
    return (
        <div  className='mt-15' >
            <div className='flex flex-col md:flex-row  md:gap-8 gap-3 items-center md:ml-25 ' >
                ...
                <div>
                    <h2 className='font-black md:text-3xl text-[#001931] mb-3 text-lg' >{description}</h2>
                    <p className='text-[#627382] md:text-xl text-sm ' >Developed by <span className='font-semibold md:text-xl  text-sm bg-linear-to-r from-[#632EE3] to-[#9F62F2] text-transparent bg-clip-text ' >{companyName}</span></p>
                    ...
                    <button className='btn bg-[#00D390] text-white p-2 mt-7 '>Install Now ({size}MB)</button>
